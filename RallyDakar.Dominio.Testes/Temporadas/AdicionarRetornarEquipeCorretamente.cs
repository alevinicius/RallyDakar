...
//Essa classe possui testes pouco realistas.
//Mas a intenção é testar a validação das regras de negócio aqui
//Fica registrado para consulta posterior
namespace RallyDakar.Dominio.Testes.Temporadas
{
    [TestClass]
    public class AdicionarRetornarEquipeCorretamente
    {
        Temporada temporada;
        Equipe equipe1;
        Equipe equipe2;
